...
parser.add_argument('--data', type=str, default='/media/lab540/disk1/wmf997/wanghaiyang/search_attention/data', help='location of the data corpus')
...
parser.add_argument('--exp_path', type=str, default='/media/lab540/disk2/why/code/fine-tuning/search_', help='experiment name')
