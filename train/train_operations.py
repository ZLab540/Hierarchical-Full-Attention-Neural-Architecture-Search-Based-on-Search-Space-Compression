...
#     'attention_3*3_group_16': lambda C, stride, affine: Attention(C, C, 3, stride, 1, 16, affine=affine),
#     'attention_5*5_group_16': lambda C, stride, affine: Attention(C, C, 5, stride, 2, 16, affine=affine),
#     'attention_7*7_group_16': lambda C, stride, affine: Attention(C, C, 7, stride, 3, 16, affine=affine),
