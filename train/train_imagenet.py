...
parser.add_argument('--init_channels', type=int, default=112, help='num of init channels')
parser.add_argument('--layers', type=int, default=5, help='total number of layers')
parser.add_argument('--auxiliary', action='store_true', default=False, help='use auxiliary tower')
parser.add_argument('--auxiliary_weight', type=float, default=0.4, help='weight for auxiliary loss')
parser.add_argument('--drop_path_prob', type=float, default=0, help='drop path probability')
parser.add_argument('--save', type=str, default='trainpath0830', help='experiment name')
...
if __name__ == '__main__':
    ...
    if args.pretrained_model:
        filename = 'best_model_60_ckpt.tar'
        print('filename :: ', filename)
        file_path = os.path.join('I:/imagenet/code_9_20', filename)
        checkpoint = torch.load(file_path)
        model.load_state_dict(checkpoint['state_dict'])
        start_epoch = 0
        best_acc_top1 = checkpoint['best_acc_top1']
        # optimizer.load_state_dict(checkpoint['optimizer'])
        print('Load model, Start_epoch: {0}, Acc: {1}'.format(start_epoch, best_acc_top1))
        logging.info('Load model,  Start_epoch: {0}, Acc: {1}'.format(start_epoch, best_acc_top1))
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if valid_acc_top1 > best_acc_top1:
            ...
            is_best = True
        logging.info('best_acc: %f', best_acc_top1)
